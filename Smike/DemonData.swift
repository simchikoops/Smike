...
let devilValues: DemonValues = (imageName: "devil", speed: 15, hp: 100, attack: .thrust, attackImage: nil, attackRange: 200, attackAngle: 300...390, attackOrigin: CGPoint(x: 130, y: 100), attackPower: 20, attackSpeed: nil, minimumAttackInterval: 2.0)
